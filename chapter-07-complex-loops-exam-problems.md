...
Един от начините да намерим решението на тази задача е да създадем **пет** **`for`** цикъла, вложени един в друг, по един за всеки символ. За да гарантираме условието последния символ, който по условие е число, да бъде **по-голям** от първите два, които също са числа, ще използваме вградената функция **`max(…)`**:

![](/assets/chapter-7-2-images/01.stupid-password-generator-2.png)

**Знаете ли, че…?** 

* За удобство можем да използваме директно ASCII стойността на символа **"а"** в декларациите на циклите - **`97`**:

![](/assets/chapter-7-2-images/01.stupid-password-generator-3.png)

* Ако не сме сигурни в дадена стойност на символ или искаме да взимаме стойностите на динамично генерирани символи, можем да използваме вградената функция **`ord(char)`**, която да ни върне стойността на символа:
...
* **Python** разполага с богат набор от вградени функции и методи за работа със стрингове. Потърсете допълнителна информация за следните функции: **`str(number)`**, **`.lower()`**, **`.format(*args, **kwargs)`**, **`.swapcase()`**, **`.upper()`**.


### Тестване в Judge системата

Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1058#0](https://judge.softuni.org/Contests/Practice/Index/1058#0).
...
**Решението** на задачата за магическите числа следва **същата** концепция (отново трябва да генерираме всички комбинации за n елемента). Следвайки стъпките по-долу, се опитайте да решите задачата сами.
...
В предходната глава разгледахме и други циклични конструкции. Нека разгледаме примерно решение на същата задача, в което използваме цикъла **`while`**. Първо трябва да запишем **входното магическо число** в подходяща променлива:
...
Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1058#1](https://judge.softuni.org/Contests/Practice/Index/1058#1).
...
Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1058#2](https://judge.softuni.org/Contests/Practice/Index/1058#2).
...
Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1058#3](https://judge.softuni.org/Contests/Practice/Index/1058#3).
...
Тествайте решението си тук: [https://judge.softuni.org/Contests/Practice/Index/1058#4](https://judge.softuni.org/Contests/Practice/Index/1058#4).
